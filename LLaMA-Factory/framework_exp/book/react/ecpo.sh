...
OUTPUT_DIR="/data/fengxueyang/ecpo/framework_fine-tuning/react/ecpo/Book/lr${LEARNING_RATE}_epochs${NUM_EPOCHS}"
...
nohup llamafactory-cli train \
  ...
  --adapter_name_or_path /data/fengxueyang/ecpo/framework_fine-tuning/react/sft/Book/lr5.0e-5_epochs3.0\
  --stage dpo \
  --do_train true \
  --finetuning_type lora \
  --lora_target all \
  --dataset amazon_book_react_ecpo \
  --template llama3 \
  --cutoff_len 2048 \
