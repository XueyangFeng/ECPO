...
import sys
import os
from refine_prompts import expression_refiner_template, recommendation_refiner_template
# 获取当前工作目录
...
def refine_trajectories(tasks, openai_client, max_workers=5):
    ...
    return sft_results_2, dpo_results_2, sft_results_3, dpo_results_3, sft_results_4, dpo_results_4, sft_results_5, dpo_results_5
...
def main():
    # 读入一个文件的路径
    input_file = "./amazon_book_ecpo_raw.json"
    ...
    sft_results_2, dpo_results_2, sft_results_3, dpo_results_3, sft_results_4, dpo_results_4, sft_results_5, dpo_results_5 = refine_trajectories(tasks, openai_mini_client, max_workers=10)
    # 可选择保存到一个新的 JSON 文件
    # sft_output_file = './amazon_book_ecpo_sft.json'  # 请替换为你想保存的路径
    # dpo_output_file = './amazon_book_ecpo_dpo.json'  # 
    sft_output_file2 = './amazon_book_ecpo_sft_lambda2.json'
    dpo_output_file2 = './amazon_book_ecpo_dpo_lambda2.json'
    sft_output_file3 = './amazon_book_ecpo_sft_lambda3.json'
    dpo_output_file3 = './amazon_book_ecpo_dpo_lambda3.json'
    sft_output_file4 = './amazon_book_ecpo_sft_lambda4.json'
    dpo_output_file4 = './amazon_book_ecpo_dpo_lambda4.json'
    sft_output_file5 = './amazon_book_ecpo_sft_lambda5.json'
    dpo_output_file5 = './amazon_book_ecpo_dpo_lambda5.json'
    ...
    with open(sft_output_file2, 'w', encoding='utf-8') as outfile:
        json.dump(sft_results_2, outfile, ensure_ascii=False, indent=4)
    
    with open(dpo_output_file2, 'w', encoding='utf-8') as outfile:
        json.dump(dpo_results_2, outfile, ensure_ascii=False, indent=4)

    with open(sft_output_file3, 'w', encoding='utf-8') as outfile:
        json.dump(sft_results_3, outfile, ensure_ascii=False, indent=4)

    with open(dpo_output_file3, 'w', encoding='utf-8') as outfile:
        json.dump(dpo_results_3, outfile, ensure_ascii=False, indent=4)

    with open(sft_output_file4, 'w', encoding='utf-8') as outfile:
        json.dump(sft_results_4, outfile, ensure_ascii=False, indent=4)

    with open(dpo_output_file4, 'w', encoding='utf-8') as outfile:
        json.dump(dpo_results_4, outfile, ensure_ascii=False, indent=4)

    with open(sft_output_file5, 'w', encoding='utf-8') as outfile:
        json.dump(sft_results_5, outfile, ensure_ascii=False, indent=4)
