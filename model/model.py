...
class OpenAIClient:
    def __init__(self, base_url: str, api_key: str, model_path: str):
        self.client = OpenAI(base_url=base_url, api_key=api_key)
        self.model_path = model_path

    def get_single_chat_completion(self, user_message: str, sys_prompt: str = "You are a helpful assistant", temperature=0, response_format=None, stop=None):
            ...
            if response_format is not None:
                completion = self.client.chat.completions.create(
                    ...
                    extra_body={
                        ...
                        "truncate_prompt_tokens": 9000  # 建议设置为少于最大上下文长度
                    },
                    stop=stop,
                    temperature=temperature,
                )
